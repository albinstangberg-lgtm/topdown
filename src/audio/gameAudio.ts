  ...
  private onNoise(n: Noise): void {
    ...
    switch (n.kind) {
      ...
      case "step":
        ...
        break;
      case "groan":
        // The sound of being found. Low, wet and falling — deliberately unlike anything
        // the squad can make, because hearing one means something has eyes on somebody
        // and every dead thing in the next two rooms heard it too.
        this.bus.tone("groan", at, { freq: 132, to: 78, type: "sawtooth", decay: 0.5, level: 0.24 });
        this.bus.noise("groanAir", at, { freq: 620, q: 0.8, decay: 0.42, level: 0.2, sweepTo: 280 });
        break;
      case "drag":
